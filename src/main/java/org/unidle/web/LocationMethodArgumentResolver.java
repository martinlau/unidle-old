...
@Component
public class LocationMethodArgumentResolver implements HandlerMethodArgumentResolver {

    private final LocationService locationService;

    public LocationMethodArgumentResolver(final LocationService locationService) {
