...
@WebAppConfiguration
public class PostConnectControllerTest {
    ...
    @Test
    public void testPostFacebook() throws Exception {
        subject.perform(get("/connect/facebookConnected"))
               .andExpect(view().name("redirect:/account"));
    }

    @Test
    public void testPostTwitter() throws Exception {
        subject.perform(get("/connect/twitterConnected"))
               .andExpect(view().name("redirect:/account"));
    }
