...
public class QuestionControllerTest {
    ...
    public void testQuestion() throws Exception {
        subject.perform(get("/question/" + question.getUuid()))
               .andExpect(status().isOk())
               .andExpect(model().attribute("question", equalTo(question)));
    }

    @Test
    public void testQuestionWithUnknownQuestion() throws Exception {
        subject.perform(get("/question/" + UUID.randomUUID()))
