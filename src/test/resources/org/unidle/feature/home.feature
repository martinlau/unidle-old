Feature: Home page customisation
    ...
    Examples:
        ...
        | Global                       | 127.0.0.1       | Every day in 800000 people spend 75 minutes on public transport.                 | Bureau of Transport Statistics, Transport for NSW | That's over 100 years spent checking facebook, reading the paper or staring out of the window. |
        | Oceania                      | 210.48.81.144   | Every day in Oceania 800000 people spend 75 minutes on public transport.         | Bureau of Transport Statistics, Transport for NSW | That's over 100 years spent checking facebook, reading the paper or staring out of the window. |
        | Australia                    | 1.44.224.0      | Every day in Australia 800000 people spend 75 minutes on public transport.       | Bureau of Transport Statistics, Transport for NSW | That's over 100 years spent checking facebook, reading the paper or staring out of the window. |
        ...
        | New South Wales              | 1.41.148.137    | Every day in New South Wales 800000 people spend 75 minutes on public transport. | Bureau of Transport Statistics, Transport for NSW | That's over 100 years spent checking facebook, reading the paper or staring out of the window. |
        ...
        | Sydney                       | 203.27.21.6     | Every day in Sydney 800000 people spend 75 minutes on public transport.          | Bureau of Transport Statistics, Transport for NSW | That's over 100 years spent checking facebook, reading the paper or staring out of the window. |
