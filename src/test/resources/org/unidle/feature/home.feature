Feature: Home page customisation
    ...
    Examples:
        ...
        | Northern Territory           | 113.197.6.245   | Every day in Northern Territory 1 person spends 1 minute doing stuff.             | Martin's Imagination                              | That's over 1 year spent checking facebook, reading the paper or staring out of the window.    |
        ...
        | Australian Capital Territory | 60.242.111.148  | Every day in Australian Capital Territory 1 person spends 1 minute doing stuff.   | Martin's Imagination                              | That's over 1 year spent checking facebook, reading the paper or staring out of the window.    |
